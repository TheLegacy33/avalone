			...
			<header>
				<div>
					<a id="logo" href="index.php">
						<p class="top"><span class="orange">AVA</span><span class="standard">LONE</span></p>
						<p class="bottom">Solutions de développement Web &amp; Applicatives</p>	
					</a>
					<div id="search">
						<form id="search-box" method="get" action="" name="search">
							<div class="query">
								<input type="text" value="Rechercher..." name="q" onclick="this.value=''">
							</div>
							<div class="submit">
								<input type="submit" alt="Rechercher" value=" ">
							</div>
						</form>
					</div>
					<div id="phonenumber">
